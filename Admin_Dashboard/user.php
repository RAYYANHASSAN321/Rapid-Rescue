    ...
    <div class="row">
        ...
        <div class="table-responsive" enctype="multipart/form-data">
          <table class="table table-hover">
              <thead>
                <tr>
                  <th style="background-color: #b71c1c;color: white;" class="border-bottom-5 border-danger">User Name</th>
                  <th style="background-color: #b71c1c;color: white;" class="border-bottom-5 border-danger">User Email</th>
                  <th style="background-color: #b71c1c;color: white;" class="border-bottom-5 border-danger">User Image</th>
            ...
            ?>
                    <tr>
                    <td class="border-bottom-5"><?php echo $row['u_name']?></td>
                    <td class="border-bottom-5"><?php echo $row['u_email']?></td>
                    <td><img src="<?php echo 'images/' . $row['u_img'] ?>" width="50" height="50" alt=""></td>
                    <td class="border-bottom-5">
                    <a class="btn btn-danger btm-lg border border-white border-1 px-3 w-100" href="Dash_Admin_Delete.php?id=<?php echo $row['u_id']; ?>">Delete</a> </td>
                  </tr>
            <?php
                    }
                }
